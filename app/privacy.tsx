      ...
      >
        ...
        <View style={styles.copyrightSection}>
          <Text style={styles.copyrightText}>
            Copyright-Hinweis: Diese Datenschutzerkl{'\u00e4'}rung wurde von den Fachanw{'\u00e4'}lten der IT-Recht Kanzlei erstellt und ist urheberrechtlich gesch{'\u00fc'}tzt (https://www.it-recht-kanzlei.de)
          </Text>
        </View>
      </ScrollView>
    </View>
